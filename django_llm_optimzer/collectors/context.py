...
_active_trace: ContextVar[RequestTrace | None] = ContextVar("django_llm_optimzer_active_trace", default=None)
_last_trace: ContextVar[RequestTrace | None] = ContextVar("django_llm_optimzer_last_trace", default=None)
